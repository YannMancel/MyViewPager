...
public class NewsPageFragment extends Fragment {
    ...
    private static String BUNDLE_COLOR = "com.mancel.yann.myviewpager.controller.fragments.NewsPageFragment.BUNDLE_COLOR";
     ...
     *
     * @return a NewsPageFragment object
     */
    public static NewsPageFragment newInstance(final int color) {
        // Creates a NewsPageFragment object
    ...
    private void configureLinearLayout(final View view) {
        ...
        this.mLinearLayout = (LinearLayout) view.findViewById(R.id.fragment_news_page_LinearLayout);
    }
    ...
    private void configureTextView(final View view) {
        ...
        this.mTextView = (TextView) view.findViewById(R.id.fragment_news_page_TextView);
    }

    /**
     * Retrieves the arguments of the fragment via the Bundle object
     */
    ...
    private void updateUI() {
        ...
        this.mTextView.setText(getResources().getString(R.string.news));
    }
}
